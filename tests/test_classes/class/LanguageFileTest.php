...
class LanguageFileTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_get_data() {
        $this->assertEquals(json_decode(file_get_contents($this->base_path.DS.$this->file), true), $this->obj->get_data());
    }
    ...
    public function test_to_string() {
        $this->assertEquals(json_decode(file_get_contents($this->base_path.DS.$this->file), true), $this->obj);
    }
}
